...
export default function SearchBox() {
    ...
    InputSearchBox === document.activeElement ? (SearchValue ? SearchBoxListHere.classList.remove("SearchPopDisplayNone") : SearchBoxListHere.classList.add("SearchPopDisplayNone")) : console.log("Search Something To Explore....")
    return (
        <>
