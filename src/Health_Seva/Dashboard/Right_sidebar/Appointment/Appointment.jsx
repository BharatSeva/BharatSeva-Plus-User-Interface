...
export default function Appointment() {
    ...
    function GetApppointment() {
        SetIsData(true)
        SetData(false)
        fetch(`http://localhost:5000/api/v1/patientDetails/appointment/${localStorage.getItem("BharatSevaHealth_ID")}`, {
            method: "GET",
            headers: {
    ...
    function myvalue(e) {
        ...
        if (Data) {
            ...
            Dataapp.length ? SetData3(Dataapp.map((data) => RecordsList(data))) : SetData3(<p>No Records Found On the Selected Date</p>)
        }
        if (!value) {
            DataSelected.value = ""
        }
    ...
    return (
        <div className="appointmentContainer">
            <h2>Appointments</h2>
            <p>This Section List Your Appointments You Have Scheduled with HealthCares</p>
            <hr></hr>
            <p>Filter By Date :</p>
