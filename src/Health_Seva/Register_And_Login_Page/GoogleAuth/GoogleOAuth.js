...
function GoogleOAuth() {
    ...
    return (
        <>
            ...
            <button onClick={() => { login(); Setstatus((p) => ({ ...p, statustxt: "Authorization Flow Initiated !", message: true })) }} type="button" class="w-full flex items-center justify-center gap-4 py-3 px-6 text-sm tracking-wide text-gray-800 border border-gray-300 rounded-md bg-gray-50 hover:bg-gray-100 focus:outline-none">
