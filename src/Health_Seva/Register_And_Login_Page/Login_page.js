            ...
            <form className="mt-8 space-y-4" onSubmit={preventDefault}>
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="health_id" type="Number" required className="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter Your Health ID" onChange={Credential} onKeyUp={Credential}/>
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="password" type="password" required className="w-full text-gray-800 text-sm border border-gray-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Enter Your Password" onChange={Credential} onKeyUp={Credential}/>
              ...
              <div className="!mt-8">
                <button type="submit" className="w-full py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none" value={`${IsAuthenticated.IsFetching ? "Validating..." : "Login*"}`} disabled={IsAuthenticated.IsFetching}>
                  Sign in
                </button>
              </div>
              ...
              <p className="text-gray-800 text-sm !mt-8 text-center">Don't have an account? <a href="/user/register" class="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">Register here</a></p>
            </form>
          </div>
        </div>
      </div>
